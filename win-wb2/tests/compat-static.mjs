...
for (const marker of [
  ...
  'function dedupeHomeItemsPayload',
  ...
  'subtitle single-overlay renderer installed',
  'function startOverlaySubtitleSession',
  'function renderOverlaySubtitle',
  'jellium-embedded-subtitle-overlay',
