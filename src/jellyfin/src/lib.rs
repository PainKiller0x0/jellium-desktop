...
/// Local frontend entry point used by the desktop client.  The Jellyfin Web
/// assets are staged next to the executable; `config.json` is generated by
/// the `app://` resource handler so it can point at the saved remote server.
pub const LOCAL_WEB_URL: &str = "app://resources/jellyfin-web/index.html";
